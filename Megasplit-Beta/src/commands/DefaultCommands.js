            ...
            exec: (handle, context, args) => {
                ...
                for (let id in handle.worlds) {
                    const world = handle.worlds[id], stats = world.stats,
                        cells = [ world.cells.length, world.playerCells.length, world.pelletCount, world.virusCount, world.ejectedCells.length, world.mothercellCount, world.boosterCount],
